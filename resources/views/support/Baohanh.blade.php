          ...
          <div class="navbar-nav me-auto">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu fade-up m-0">
                ...
                >
                <hr />
                <a href="/404.html" class="dropdown-item fw-bold"
        ...
        <div class="row g-5">
          <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
            <div class="content-box" style="color: black">
              ...
              <p>
                1. Bảo hành sản phẩm là: khắc phục những lỗi hỏng hóc, sự cố kỹ
                thuật xảy ra do lỗi của nhà sản xuất
              </p>
              <p>
                2. Sản phẩm còn trong thời hạn bảo hành theo quy định của từng
                hãng sản xuất và từng thiết bị
              </p>
              <p>
                3. Có Phiếu bảo hành/tem niêm phong của nhà sản xuất hoặc nhà
                phân phối
              </p>
              <p>4. Có Hóa đơn mua hàng của OMEGA</p>
              <p>
                5. Sản phẩm bảo hành sẽ tuân theo qui định bảo hành của từng nhà
                sản xuất đối với các sự cố về mặt kỹ thuật
              </p>

              <h6>Điều khoản loại trừ:</h6>
              <p>
                1. Sản phẩm đã quá thời hạn bảo hành ghi trên phiếu Bảo hành/tem
                niêm phong hoặc mất Phiếu Bảo hành (nếu có).
              </p>
              <p>
                2. Những sản phẩm không thể xác định được nguồn gốc mua tại
                OMEGA thì chúng tôi có quyền từ chối bảo hành.
              </p>
              <p style="color: black; margin-left: 15px; line-height: 35px">
                - Mất hóa đơn <br />
                - Tem niêm phong bảo hành bị rách, vỡ, hoặc bị sửa đổi <br />
                - Phiếu bảo hành (nếu có) không ghi rõ số Serial và ngày mua
                hàng <br />
                - Số serial trên sản phẩm và Phiếu bảo hành không trùng khớp
                nhau hoặc – không xác định được vì bất kỳ lý do nào <br />
                - Số serial trên sản phẩm không xác định được <br />
                - Số serial trên sản phẩm không xác định được
              </p>
              <p>
                3. Sản phẩm bị hư hỏng do sử dụng không đúng kỹ thuật theo hướng
                dẫn của nhà sản xuất.
              </p>
              <p>
                4. Sản phẩm bị hư hỏng do tác động cơ học làm rơi, vỡ, va đập,
                trầy xước, móp méo, ẩm ướt, hoen rỉ, thấm nước.
              </p>
              <p>
                5. Sản phẩm có dấu hiệu hư hỏng do chuột bọ hoặc côn trùng xâm
                nhập hoặc do hỏa hoạn, thiên tai gây nên
              </p>
              <p>
                6. Tự ý tháo dỡ, sửa chữa bởi các cá nhân hoặc kỹ thuật viên
                không được sự ủy quyền của OMEGA
              </p>
              <h6><em>Trân trọng cảm ơn quý khách hàng!</em></h6>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container py-5">
        <div class="row g-5">
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <a class="btn btn-link" href="{{ url('/Support/Baomat.html') }}">Chính sách bảo mật thông tin</a>
