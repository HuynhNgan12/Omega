...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="margin-top: 60px">
      <div class="row g-4">
        <h1 class="text-center">Chính Sách Vận Chuyển</h1>
      </div>
        ...
        <div class="row g-5">
          <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
            <div class="content-box" style="color: black">
              <h6>Chính sách vận chuyển của Công ty TNHH Công Nghệ OMEGA</h6>
              <p style="line-height: 40px">
                Đối với chính sách vận chuyển, vì kho luôn có sẵn nên sau khi
                thỏa thuận, ở các hộ gia đình sau khi chốt ngày chúng tôi sẽ cho
                triển khai, thời gian vận chuyển trong thành phố sẽ là trong
                ngày, đối với các tỉnh thành, các miền khác thì 2-3 ngày <br />
                Ở các doanh nghiệp lớn, số lượng lớn, thời gian vận chuyển đáp
                ứng là 2-3 tuần, vì đây là sản phẩm được nhập từ Châu Âu.<br />
                Tuy nhiên, thời gian vận chuyển sẽ có thể kéo dài do các trường
                hợp bất khả kháng:
              </p>
              <p style="color: black; margin-left: 15px; line-height: 40px">
                1. Đối tác cung cấp hàng cho công ty chậm hơn dự kiến <br />
                2. Địa chỉ khách hàng khó đi lại, khó tìm <br />
                3. Mức sản phẩm tăng đột biến so với thỏa thuận ban đầu <br />
              </p>
            </div>
          </div>
        </div>
