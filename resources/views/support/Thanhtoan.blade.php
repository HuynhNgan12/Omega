...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="margin-top: 60px">
      <div class="row g-4">
        <h1 class="text-center">Chính Sách Thanh Toán</h1>
      </div>
        ...
        <div class="row g-5">
          <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
            <div class="content-box" style="color: black">
              <p>
                Khách hàng mua hàng ở OMEGA yên tâm sẽ được đội ngũ support hỗ
                trợ đặt hàng 24/24. Tư vấn viên hỗ trợ giao dịch, thương lượng
                giá và nhanh chóng.
              </p>
            </div>
          </div>
