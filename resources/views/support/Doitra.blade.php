...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="margin-top: 60px">
      <div class="row g-4">
        <h1 class="text-center">Chính Sách Đổi Trả</h1>
      </div>
        ...
        <div class="row g-5">
          <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
            <div class="content-box" style="color: black">
              <p>
                Trong trường hợp Khách hàng trả hàng mà nguyên nhân được xác
                định là do lỗi dịch vụ của OMEGA, OMEGA sẽ thực hiện việc nhận
                lại hàng tại các điểm giao dịch của OMEGA. Sau khi nhận hàng
                trả, OMEGA sẽ hoàn lại tiền hàng cho Khách hàng và chủ động thực
                hiện các hoạt động trả hàng cho NCC.
              </p>
              <p>
                Trong trường hợp Khách hàng trả hàng do lỗi từ phía NCC, không
                thuộc phạm vi cam kết các dịch vụ của OMEGA (mua hàng, vận
                chuyển, kiểm hàng):
              </p>
              <p style="color: black">
                <i
                ...
                ></i
                ><strong>
                  Nếu lỗi sai được phát hiện từ thời điểm kiểm hàng</strong
                >
                (tại kho của OMEGA) và Khách hàng không đồng ý nhận hàng lỗi,
                OMEGA sẽ làm việc với NCC để trả hàng và sẽ hoàn tiền lại cho
                Khách hàng ngay khi NCC hoàn tiền cho OMEGA.
              </p>
              <p style="color: black">
                <i
                  class="fa fa-check me-2"
                ...
                ></i
                ><strong>
                  Nếu lỗi sai được phát hiện khi Khách đã nhận hàng</strong
                >
                và không nằm trong phạm vi dịch vụ kiểm hàng của OMEGA, OMEGAchỉ
                nhận lại và thực hiện trả hàng sau khi NCC đã đồng ý việc trả
                hàng.
              </p>
            </div>
          </div>
        ...
        <div class="row g-5">
          <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
            <div class="content-box" style="color: black;">
              ...
              <p style="color: black;">
                <i class="bi bi-link-45deg" style="color: black; margin-left: 15px; font-size: 20px;"></i>C                </p>
                <p style="color: black;">
                  <i class="fa fa-check me-2" style="color: black; margin-left: 15px; font-size: 12px;"></i><strong> Nếu lỗi sai được phát hiện khi Khách đã nhận hàng</strong>   và không nằm trong phạm vi dịch vụ kiểm hàng của OMEGA, OMEGAchỉ nhận lại và thực hiện trả hàng sau khi NCC đã đồng ý việc trả hàng.
                </p>
            </div>
          </div>
        </div>
