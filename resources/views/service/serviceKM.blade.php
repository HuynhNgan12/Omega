...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Khuyến Mãi Thường Xuyên</title>
        ...
        <div class="row g-5">
          <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
            <div class="content-box" style="color: black">
              <strong>Xin kính chào quý khách !</strong>

              <p>
                Công ty TNHH Kỹ Thuật Công Nghệ OMEGA là đơn vị chuyên phân phối và cung câp các thiết bị điện chính hãng đến tay khách hàng , với các thương hiệu nổi tiếng như 
                <strong>Schneider, Duhal, Himel, Hitachi</strong>...Trong suốt quá trình xây dựng và trưởng thành , chúng tôi đã ngày càng khẳng định được vị thế của mình trong lĩnh vực phân phối , 
                cung cấp thiết bị điện không chỉ tại thị trường TPHCM mà còn cả thị trường miền Nam .
              </p>
              <p>
                Chúng tôi xin gửi lời cảm ơn chân thành đến tất cả cả khách hàng đã quan tâm và hợp tác với 
                <strong>OMEGA</strong> trong suốt thời gian qua . Chính những ưu ái mà quý khách hàng đã dành cho công ty là động lực tiếp tục đổi mới 
                và phát triển từng ngày để mang đến cho khách hàng sản phẩm và chất lượng dịch vụ tốt nhất.
              </p>
            </div>
          </div>
        </div>
