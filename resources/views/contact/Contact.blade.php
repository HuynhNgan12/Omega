      ...
      >
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <div class="navbar-nav me-auto">
            ...
            <a href="{{ route('contact.Contact') }}" class="nav-item nav-link active">Liên hệ</a>
          </div>
      ...
      <div class="container">
        <div class="row g-4">
          <div class="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <h1 class="mb-4" style="color: #004400">
              CÔNG TY TNHH KỸ THUẬT CÔNG NGHỆ OMEGA
            </h1>
            <p
              class="mb-4"
              style="color: black; font-size: 18px; line-height: 35px"
            >
              <strong> Email:</strong> omegacom.vn@gmail.com
              <!-- <a href="https://htmlcodex.com/contact-form">Download Now</a>. -->
              <br />

              <strong> Hotline:</strong> 0916 565 246 - 0907 995 267
              <br />

              <strong> Website:</strong>
              <a href="https://thietbidienomega.com/" style="color: black;">
                https://thietbidienomega.com/</a
              >
            </p>
          </div>
          <div class="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div
              class="p-5 h-100 d-flex align-items-center"
              style="background-color: honeydew"
            >
              <form>
                <div class="row g-3">
                  ...
                  <div class="col-12">
                    <button
                      class="w-100 py-3 text-white fw-bold"
