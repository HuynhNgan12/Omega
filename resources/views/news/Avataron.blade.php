...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Báo giá công tắc ổ cắm AvatarOn Schneider</title>
  ...
  <body>
    ...
    <div class="container" style="margin-top: 60px">
      <div class="row g-4">
        <h1 class="text-center">Báo giá công tắc ổ cắm AvatarOn Schneider</h1>
      </div>
            ...
            <div class="content-box" style="color: black">
              <ul style="list-style-type: none; font-size: 18px">
                <li style="margin-bottom: 10px">
                  <a
                    href="#section1"
                    onclick="scrollToSection(event, 'section1')"
                    style="color: black"
                    >1. <strong>Báo giá công tắc dòng AvatarOn</strong></a
                  >
                </li>
                <li style="margin-bottom: 10px">
                  <a
                    href="#section2"
                    onclick="scrollToSection(event, 'section2')"
                    style="color: black"
                    >2. <strong>Báo giá ổ cắm dòng AvatarOn</strong></a
                  >
                </li>
                <li style="margin-bottom: 10px">
                  <a
                    href="#section3"
                    onclick="scrollToSection(event, 'section3')"
                    style="color: black"
                    >3.
                    <strong
                      >Báo giá ổ cắm TV, mạng, điện thoại dòng AvatarOn</strong
                    ></a
                  >
                </li>
                <li style="margin-bottom: 10px">
                  ...
                  >
                    4.
                    <strong
                      >Báo giá thiết bị dành cho khách sạn dòng AvatarOn</strong
                    ></a
                  >
                </li>
                <li style="margin-bottom: 10px">
                  <a
                    ...
                    onclick="scrollToSection(event, 'section3')"
                    style="color: black"
                    >5. <strong>Báo giá phụ kiện dòng AvatarOn</strong></a
                  >
                </li>
              </ul>
            </div>
      ...
      <div class="container">
        <div class="row g-5">
          <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
            <div class="content-box" style="color: black">
              <strong>
                <h5 id="section1">Báo giá công tắc dòng AvatarOn</h5>
              </strong>

              <p>
                Công tắc dòng AvatarOn được chia thành khá nhiều dạng nên sẽ
                mang tới cho người dùng sự tiện dụng và thuận tiện trong khâu
                lựa chọn.
              </p>
              <p>
                Tiêu biểu cần phải kể đến các dòng công tắc AvatarOn phổ biến
              ...
              <p>
                Tùy theo tùy chọn màu mà giá thành của công tắc ổ cắm AvatarOn
                sẽ có sự chênh lệch nhất định. Trong đó, giá của công tắc
                AvatarOn màu trắng là rẻ nhất sau đó đến màu vàng và cao nhất là
                màu gỗ.
              </p>
              <p>
                Xem báo giá công tắc AvatarOn
                <a
                  href="https://thietbidienschneider.com/danh-muc/cong-tac-o-cam/cong-tac-o-cam-avataron/"
                  class="fw-bold"
                  style="color: red"
                  >tại đây</a
                >
              </p>
              <h5 id="section2">Báo giá ổ cắm dòng AvatarOn</h5>
              <p>
                Ổ cắm AvatarOn có thiết kế hết sức thông minh và tiện dụng. Các
                ...
                nhiều thiết bị tiêu thụ điện khác nhau trong gia đình.
              </p>
              <h5 id="section3">
                Báo giá ổ cắm TV, mạng, điện thoại dòng AvatarOn
              </h5>
              <p>
                Nằm trong top ổ cắm điện thông minh, ổ cắm AvatarOn mang tới cho
                bạn sự tiện dụng hơn hẳn. Theo đó, bạn có thể sử dụng ổ cắm
                AvatarOn để cắm mạng, cắm tivi hoặc cắm điện thoại hay cắm USB…
              </p>
              <p>
                Tùy theo nhu cầu sử dụng, bạn có thể chọn ổ cắm tivi đơn, ổ cắm
                ...
                công tắc ổ cắm, bạn sẽ có 3 tùy chọn về màu sắc.
              </p>
              <p>
                Xem báo giá ổ cắm TV, mạng, điện thoại AvatarOn
                <a
                  href="https://thietbidienschneider.com/san-pham/"
                  class="fw-bold"
                  style="color: red"
                  >tại đây</a
                >
              ...
              <h5 id="section4">
                Báo giá thiết bị dành cho khách sạn dòng AvatarOn
              </h5>
              <p>
                Điểm đặc biệt ở dòng sản phẩm công tắc ổ cắm AvatarOn là còn có
                ...
                “không làm phiền”, “xin dọn phòng”, “vui lòng chờ”.
              </p>
              <h5 id="section5">Báo giá phụ kiện dòng AvatarOn</h5>
              <p>
                Phụ kiện dòng AvatarOn gồm có mặt che trơn và đế âm cho mặt đơn
