...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Cách phân biệt MCB và MCCB chi tiết nhất</title>
  ...
  <body>
    ...
    <div class="container" style="margin-top: 60px">
      <div class="row g-4">
        <h1 class="text-center">Cách phân biệt MCB và MCCB chi tiết nhất</h1>
      </div>
              ...
              <ul style="list-style-type: none; font-size: 18px">
                <li style="margin-bottom: 10px">
                  <a
                    ...
                    style="color: black"
                    >1. <strong>MCB là gì? MCCB là gì?</strong></a
                  >
                </li>
                <li style="margin-bottom: 10px">
                  <a
                    ...
                    style="color: black"
                    >2. <strong>5 cách để phân biệt MCB và MCCB</strong></a
                  >
                </li>
              </ul>
            </div>
      ...
      <div class="container">
        <div class="row g-5">
          <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
            <div class="content-box" style="color: black">
              <strong>
                <h5 id="section1">MCB là gì? MCCB là gì?</h5>
              </strong>

              <p>
                MCB hay còn được gọi là thiết bị chuyển mạch loại tép. Theo đó,
                sản phẩm có dòng cắt định mức và dòng cắt ngắn mạch thấp.
              </p>
              <p>
              ...
              <strong>
                <h5 id="section2">5 cách để phân biệt MCB và MCCB</h5>
              </strong>
              <ul>
                <li>MCCB có vỏ đúc nguyên khối</li>
                <li>
                  Dòng điện định mức in của MCB ở khoảng <=125A còn MCCB ở
                  khoảng 100-1600A
                </li>
                <li>
                  Dòng cắt của MCB nhỏ hơn, ở khoảng 25kA còn dòng cắt MCCB thì
                  ở khoảng 150kA
                </li>
                <li>
                  Chỉ có MCCB mới có khả năng mở rộng tùy chỉnh, truyền thông và
                  điều khiển từ xa. Tiêu biểu như việc tích hợp với cặp NO- NC
                  hay cặp trạng thái điều khiển chế độ on – of – trip.
                </li>
                <li>
                  Duy nhất ở MCCB mới có khả năng tích hợp module truyền thống.
                  Khi tích hợp module này, bạn có thể dễ dàng giám sát và điều
                  khiển từ xa một cách dễ dàng
                </li>
              </ul>
              <h5 style="margin-left: 10px">Ứng dụng của MCB và MCCB</h5>
              <ul>
                <li>
                  <p>
                    <a
                      href="https://vi.wikipedia.org/wiki/C%E1%BA%A7u_dao"
                      style="font-weight: bold; color: red"
                      >MCB</a
                    >
                    thường được sử dụng trong các mạch điện dân dụng như là MCB
                    1P, MCB 2P. Đây là dòng sản phẩm rất thường gặp trong mạng
                    điện gia đình hoặc trong các tủ điện phân phối chiếu sáng
                    hoặc ổ cắm.
                  </p>
                  <p>
                    Còn MCCB thì được ứng dụng nhiều trong các tủ điện tổng hoặc
                    tủ điện phân phối của các công trình lớn. Theo đó, trong hệ
                    thống tủ điện phân phối này thì thường có MCCB và nhiều MCB
                    tép.
                  </p>
                </li>
              </ul>
