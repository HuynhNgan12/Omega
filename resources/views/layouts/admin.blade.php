...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="https://maxcdn.bootstrapcdn.com/font-awesome/5.3.0/css/font-awesome.min.css"
    />
  ...
  <body class="app sidebar-mini rtl">
    ...
    <header class="app-header">
      ...
      <ul class="app-nav">
        <!-- User Menu-->
        <li>
          <a class="app-nav__item" href="{{route('layouts.home')}}"
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li>
          <a class="app-menu__item" href="{{route('admin.tintuc.index')}}">
            <i class="app-menu__icon fas fa-newspaper"></i>
            <span class="app-menu__label">Tin tức</span>
          </a>
        </li>
        <li>
          <a class="app-menu__item" href="{{route('admin.cart.index')}}">
